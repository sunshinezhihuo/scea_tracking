function [Track, NewT, param] = track_initialization(InitObj, InitObj_Hist, InitObj_App_Set, Track, NewT, param)
...
if(isempty(Track) && ~isempty(InitObj))
    ...
    for i = 1:size(InitObj,2)
        ...
        Track{idx}.states_online = Track{idx}.states;
        ...
        Track{idx}.frame_online = InitObj{i}(5,:); % history of frame
        ...
        Track{idx}.AppearanceSet = InitObj_App_Set{i};
        % RMN
